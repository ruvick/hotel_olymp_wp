			...
			<div class="contacts-bg__text-block text-block">
				...
				<div class="contacts-bg__row d-flex">
					<div class="contacts-bg__col">
						<h3 class="contacts-bg__title title"><? echo pll_e("Бронирование") ?></h3>
					...
					<div class="contacts-bg__col">
						<h3 class="contacts-bg__title title"><? echo pll_e("Ресторан") ?></h3>
					...
					<div class="contacts-bg__col">
						<h3 class="contacts-bg__title title"><? echo pll_e("Конференц-зал") ?></h3>
