...
<div class="restaurant__col d-flex">
	<a href="<?php echo wp_get_attachment_image_src(carbon_get_post_meta(get_the_ID(),"sample_img_small_1"), 'full')[0];?>" data-lightbox="gallery" class="restaurant__img">
		<img src="<?php echo wp_get_attachment_image_src(carbon_get_post_meta(get_the_ID(),"sample_img_small_1"), 'full')[0];?>" alt="">
	</a>
	<a href="<?php echo wp_get_attachment_image_src(carbon_get_post_meta(get_the_ID(),"sample_img_small_2"), 'full')[0];?>" data-lightbox="gallery" class="restaurant__img">
		<img src="<?php echo wp_get_attachment_image_src(carbon_get_post_meta(get_the_ID(),"sample_img_small_2"), 'full')[0];?>" alt="">
	</a>
	<a href="<?php echo wp_get_attachment_image_src(carbon_get_post_meta(get_the_ID(),"sample_img_horizontal"), 'full')[0];?>" data-lightbox="gallery" class="restaurant__img">
...
<div class="sample__row restaurant-img__row d-flex">
	...
	<a href="<?php echo wp_get_attachment_image_src(carbon_get_post_meta(get_the_ID(),"sample_2_img_vertical"), 'full')[0];?>" data-lightbox="gallery" class="restaurant__img-big">
		<img src="<?php echo wp_get_attachment_image_src(carbon_get_post_meta(get_the_ID(),"sample_2_img_vertical"), 'full')[0];?>" alt="">
	</a>

	<div class="restaurant__col d-flex">
		<a href="<?php echo wp_get_attachment_image_src(carbon_get_post_meta(get_the_ID(),"sample_2_img_small_1"), 'full')[0];?>" data-lightbox="gallery" class="restaurant__img">
			<img src="<?php echo wp_get_attachment_image_src(carbon_get_post_meta(get_the_ID(),"sample_2_img_small_1"), 'full')[0];?>" alt="">
		</a>
		<a href="<?php echo wp_get_attachment_image_src(carbon_get_post_meta(get_the_ID(),"sample_2_img_small_2"), 'full')[0];?>" data-lightbox="gallery" class="restaurant__img">
			<img src="<?php echo wp_get_attachment_image_src(carbon_get_post_meta(get_the_ID(),"sample_2_img_small_2"), 'full')[0];?>" alt="">
		</a>
		<a href="<?php echo wp_get_attachment_image_src(carbon_get_post_meta(get_the_ID(),"sample_2_img_horizontal"), 'full')[0];?>" data-lightbox="gallery" class="restaurant__img">
